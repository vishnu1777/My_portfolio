...
function ContactMe({pageInfo}: Props) {
  ...
  return (
    ...
    z-0'>
        <h3 className='absolute top-20 md:top-24 uppercase mb-5 tracking-[20px] text-gray-500 text-2xl xl:top-14'>
            Contact
        </h3>
        <div className='flex flex-col space-y-6'>
            ...
            <div className='space-y-10'>
                ...
                <p className='text-2xl  md:text-2xl'>{pageInfo?.phoneNumber}</p>
                </div>


                <div className='flex items-center space-x-5 justify-center'>
                <EnvelopeIcon className='text-[#F7AB0A]  h-7 w-7 animate-pulse'/>
                <p className='text-2xl  md:text-2xl'>{pageInfo?.email}</p>
                </div>
